...
`func (o *IdentityProviderRepresentation) GetTypes() []string`

GetTypes returns the Types field if non-nil, zero value otherwise.

### GetTypesOk

`func (o *IdentityProviderRepresentation) GetTypesOk() (*[]string, bool)`
...
`func (o *IdentityProviderRepresentation) SetTypes(v []string)`

SetTypes sets Types field to given value.

### HasTypes

`func (o *IdentityProviderRepresentation) HasTypes() bool`
