...
`func (o *EventRepresentation) GetId() string`

GetId returns the Id field if non-nil, zero value otherwise.

### GetIdOk

`func (o *EventRepresentation) GetIdOk() (*string, bool)`
...
`func (o *EventRepresentation) SetId(v string)`

SetId sets Id field to given value.

### HasId

`func (o *EventRepresentation) HasId() bool`
