...
> []GroupRepresentation AdminRealmsRealmGroupsGet(ctx, realm).BriefRepresentation(briefRepresentation).Exact(exact).First(first).Max(max).PopulateHierarchy(populateHierarchy).Q(q).Search(search).SubGroupsCount(subGroupsCount).Execute()
...
func main() {
	...
	search := "search_example" // string |  (optional)
	subGroupsCount := true // bool | Boolean which defines whether to return the count of subgroups for each group (default: true (optional) (default to true)

	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.GroupsAPI.AdminRealmsRealmGroupsGet(context.Background(), realm).BriefRepresentation(briefRepresentation).Exact(exact).First(first).Max(max).PopulateHierarchy(populateHierarchy).Q(q).Search(search).SubGroupsCount(subGroupsCount).Execute()
	if err != nil {
 ...
 **q** | **string** |  | 
 **search** | **string** |  | 
 **subGroupsCount** | **bool** | Boolean which defines whether to return the count of subgroups for each group (default: true | [default to true]
...
> []GroupRepresentation AdminRealmsRealmGroupsGroupIdChildrenGet(ctx, realm, groupId).BriefRepresentation(briefRepresentation).Exact(exact).First(first).Max(max).Search(search).SubGroupsCount(subGroupsCount).Execute()
...
func main() {
	...
	subGroupsCount := true // bool | Boolean which defines whether to return the count of subgroups for each subgroup of this group (default: true (optional) (default to true)

	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.GroupsAPI.AdminRealmsRealmGroupsGroupIdChildrenGet(context.Background(), realm, groupId).BriefRepresentation(briefRepresentation).Exact(exact).First(first).Max(max).Search(search).SubGroupsCount(subGroupsCount).Execute()
	if err != nil {
 ...
 **subGroupsCount** | **bool** | Boolean which defines whether to return the count of subgroups for each subgroup of this group (default: true | [default to true]
