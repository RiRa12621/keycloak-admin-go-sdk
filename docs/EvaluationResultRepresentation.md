...
**DeniedScopes** | Pointer to [**[]ScopeRepresentation**](ScopeRepresentation.md) |  | [optional] 
...
GetDeniedScopes returns the DeniedScopes field if non-nil, zero value otherwise.

### GetDeniedScopesOk

`func (o *EvaluationResultRepresentation) GetDeniedScopesOk() (*[]ScopeRepresentation, bool)`

GetDeniedScopesOk returns a tuple with the DeniedScopes field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.
...
SetDeniedScopes sets DeniedScopes field to given value.
