...
> []UserRepresentation AdminRealmsRealmClientsClientUuidRolesRoleNameGroupsGet(ctx, realm, clientUuid, roleName).BriefRepresentation(briefRepresentation).First(first).Max(max).Execute()
...
func main() {
	...
	// response from `AdminRealmsRealmClientsClientUuidRolesRoleNameGroupsGet`: []UserRepresentation
...
> []UserRepresentation AdminRealmsRealmRolesRoleNameGroupsGet(ctx, realm, roleName).BriefRepresentation(briefRepresentation).First(first).Max(max).Execute()
...
func main() {
	...
	// response from `AdminRealmsRealmRolesRoleNameGroupsGet`: []UserRepresentation
