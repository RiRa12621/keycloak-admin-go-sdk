...
------------- | ------------- | -------------
[**AdminRealmsRealmOrganizationsCountGet**](OrganizationsAPI.md#AdminRealmsRealmOrganizationsCountGet) | **Get** /admin/realms/{realm}/organizations/count | Returns the organizations counts.
...
> int64 AdminRealmsRealmOrganizationsCountGet(ctx, realm).Exact(exact).Q(q).Search(search).Execute()
...
func main() {
	...
	resp, r, err := apiClient.OrganizationsAPI.AdminRealmsRealmOrganizationsCountGet(context.Background(), realm).Exact(exact).Q(q).Search(search).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `OrganizationsAPI.AdminRealmsRealmOrganizationsCountGet``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `AdminRealmsRealmOrganizationsCountGet`: int64
	fmt.Fprintf(os.Stdout, "Response from `OrganizationsAPI.AdminRealmsRealmOrganizationsCountGet`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiAdminRealmsRealmOrganizationsCountGetRequest struct via the builder pattern
...
func main() {
	realm := "realm_example" // string | realm name (not id!)
	briefRepresentation := true // bool | if false, return the full representation. Otherwise, only the basic fields are returned. (optional) (default to true)
	exact := true // bool | Boolean which defines whether the param 'search' must match exactly or not (optional)
 ...
 **briefRepresentation** | **bool** | if false, return the full representation. Otherwise, only the basic fields are returned. | [default to true]
 **exact** | **bool** | Boolean which defines whether the param &#39;search&#39; must match exactly or not | 
...
> []OrganizationRepresentation AdminRealmsRealmOrganizationsMembersMemberIdOrganizationsGet(ctx, realm, memberId).BriefRepresentation(briefRepresentation).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.OrganizationsAPI.AdminRealmsRealmOrganizationsMembersMemberIdOrganizationsGet(context.Background(), realm, memberId).BriefRepresentation(briefRepresentation).Execute()
	if err != nil {
...
func main() {
	realm := "realm_example" // string | realm name (not id!)
	orgId := "orgId_example" // string | 
	body := "body_example" // string | Payload should contain only id or alias of the identity provider to be associated with the organization (id or alias with or without quotes). Surrounding whitespace characters will be trimmed.
 ...
 **body** | **string** | Payload should contain only id or alias of the identity provider to be associated with the organization (id or alias with or without quotes). Surrounding whitespace characters will be trimmed. | 
...
> []OrganizationRepresentation AdminRealmsRealmOrganizationsOrgIdMembersMemberIdOrganizationsGet(ctx, realm, orgId, memberId).BriefRepresentation(briefRepresentation).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.OrganizationsAPI.AdminRealmsRealmOrganizationsOrgIdMembersMemberIdOrganizationsGet(context.Background(), realm, orgId, memberId).BriefRepresentation(briefRepresentation).Execute()
	if err != nil {
...
func main() {
	realm := "realm_example" // string | realm name (not id!)
	orgId := "orgId_example" // string | 
	body := "body_example" // string | Payload should contain only id of the user to be added to the organization (UUID with or without quotes). Surrounding whitespace characters will be trimmed.
 ...
 **body** | **string** | Payload should contain only id of the user to be added to the organization (UUID with or without quotes). Surrounding whitespace characters will be trimmed. | 
