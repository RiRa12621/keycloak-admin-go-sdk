...
`func (o *AdminEventRepresentation) GetId() string`

GetId returns the Id field if non-nil, zero value otherwise.

### GetIdOk

`func (o *AdminEventRepresentation) GetIdOk() (*string, bool)`
...
`func (o *AdminEventRepresentation) SetId(v string)`

SetId sets Id field to given value.

### HasId

`func (o *AdminEventRepresentation) HasId() bool`
