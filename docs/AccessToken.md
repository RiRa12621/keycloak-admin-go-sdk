...
`func (o *AccessToken) GetAddress() map[string]interface{}`

GetAddress returns the Address field if non-nil, zero value otherwise.

### GetAddressOk

`func (o *AccessToken) GetAddressOk() (*map[string]interface{}, bool)`
...
`func (o *AccessToken) SetAddress(v map[string]interface{})`
