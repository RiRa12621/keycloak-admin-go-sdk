...
type ApiAdminRealmsRealmOrganizationsCountGetRequest struct {
	ctx        context.Context
...
func (r ApiAdminRealmsRealmOrganizationsCountGetRequest) Exact(exact bool) ApiAdminRealmsRealmOrganizationsCountGetRequest {
	r.exact = &exact
	return r
}

// A query to search for custom attributes, in the format &#39;key1:value2 key2:value2&#39;
func (r ApiAdminRealmsRealmOrganizationsCountGetRequest) Q(q string) ApiAdminRealmsRealmOrganizationsCountGetRequest {
	r.q = &q
	return r
}

// A String representing either an organization name or domain
func (r ApiAdminRealmsRealmOrganizationsCountGetRequest) Search(search string) ApiAdminRealmsRealmOrganizationsCountGetRequest {
	r.search = &search
	return r
}

func (r ApiAdminRealmsRealmOrganizationsCountGetRequest) Execute() (int64, *http.Response, error) {
	return r.ApiService.AdminRealmsRealmOrganizationsCountGetExecute(r)
}

/*
AdminRealmsRealmOrganizationsCountGet Returns the organizations counts.

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param realm realm name (not id!)
	@return ApiAdminRealmsRealmOrganizationsCountGetRequest
*/
func (a *OrganizationsAPIService) AdminRealmsRealmOrganizationsCountGet(ctx context.Context, realm string) ApiAdminRealmsRealmOrganizationsCountGetRequest {
	return ApiAdminRealmsRealmOrganizationsCountGetRequest{
		ApiService: a,
		ctx:        ctx,
		realm:      realm,
...
//
//	@return int64
func (a *OrganizationsAPIService) AdminRealmsRealmOrganizationsCountGetExecute(r ApiAdminRealmsRealmOrganizationsCountGetRequest) (int64, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "OrganizationsAPIService.AdminRealmsRealmOrganizationsCountGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/admin/realms/{realm}/organizations/count"
...
func (a *OrganizationsAPIService) AdminRealmsRealmOrganizationsGetExecute(r ApiAdminRealmsRealmOrganizationsGetRequest) ([]OrganizationRepresentation, *http.Response, error) {
	...
	if r.briefRepresentation != nil {
		...
		parameterAddToHeaderOrQuery(localVarQueryParams, "briefRepresentation", defaultValue, "form", "")
...
// if false, return the full representation. Otherwise, only the basic fields are returned.
func (r ApiAdminRealmsRealmOrganizationsMembersMemberIdOrganizationsGetRequest) BriefRepresentation(briefRepresentation bool) ApiAdminRealmsRealmOrganizationsMembersMemberIdOrganizationsGetRequest {
	r.briefRepresentation = &briefRepresentation
	return r
}
...
// if false, return the full representation. Otherwise, only the basic fields are returned.
func (r ApiAdminRealmsRealmOrganizationsOrgIdMembersMemberIdOrganizationsGetRequest) BriefRepresentation(briefRepresentation bool) ApiAdminRealmsRealmOrganizationsOrgIdMembersMemberIdOrganizationsGetRequest {
	r.briefRepresentation = &briefRepresentation
	return r
}
