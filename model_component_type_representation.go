...
func (o *ComponentTypeRepresentation) GetClientProperties() []ConfigPropertyRepresentation {
...
// and a boolean to check if the value has been set.
func (o *ComponentTypeRepresentation) GetClientPropertiesOk() ([]ConfigPropertyRepresentation, bool) {
	if o == nil || IsNil(o.ClientProperties) {
		return nil, false
	}
...
func (o *ComponentTypeRepresentation) HasClientProperties() bool {
	if o != nil && !IsNil(o.ClientProperties) {
		return true
	}
...
// SetClientProperties gets a reference to the given []ConfigPropertyRepresentation and assigns it to the ClientProperties field.
func (o *ComponentTypeRepresentation) SetClientProperties(v []ConfigPropertyRepresentation) {
...
func (o ComponentTypeRepresentation) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.ClientProperties) {
		toSerialize["clientProperties"] = o.ClientProperties
	}
	if !IsNil(o.Metadata) {
