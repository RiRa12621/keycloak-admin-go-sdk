...
func (o *PolicyEvaluationRequest) GetResourceType() string {
...
// and a boolean to check if the value has been set.
func (o *PolicyEvaluationRequest) GetResourceTypeOk() (*string, bool) {
	if o == nil || IsNil(o.ResourceType) {
		return nil, false
	}
...
func (o *PolicyEvaluationRequest) HasResourceType() bool {
	if o != nil && !IsNil(o.ResourceType) {
		return true
	}
...
func (o *PolicyEvaluationRequest) SetResourceType(v string) {
	o.ResourceType = &v
}
