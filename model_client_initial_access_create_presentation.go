...
func (o *ClientInitialAccessCreatePresentation) GetWebOrigins() []string {
...
// and a boolean to check if the value has been set.
func (o *ClientInitialAccessCreatePresentation) GetWebOriginsOk() ([]string, bool) {
	if o == nil || IsNil(o.WebOrigins) {
		return nil, false
	}
...
func (o *ClientInitialAccessCreatePresentation) HasWebOrigins() bool {
	if o != nil && !IsNil(o.WebOrigins) {
		return true
	}
...
func (o *ClientInitialAccessCreatePresentation) SetWebOrigins(v []string) {
	o.WebOrigins = v
}
