...
type ApiAdminRealmsRealmIdentityProviderUploadCertificatePostRequest struct {
	ctx        context.Context
	ApiService *ClientAttributeCertificateAPIService
	realm      string
}

func (r ApiAdminRealmsRealmIdentityProviderUploadCertificatePostRequest) Execute() (*CertificateRepresentation, *http.Response, error) {
	return r.ApiService.AdminRealmsRealmIdentityProviderUploadCertificatePostExecute(r)
}

/*
AdminRealmsRealmIdentityProviderUploadCertificatePost Uploads a certificate, prepares the jwks or public key associated, and returns the certificate representation.

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param realm realm name (not id!)
	@return ApiAdminRealmsRealmIdentityProviderUploadCertificatePostRequest
*/
func (a *ClientAttributeCertificateAPIService) AdminRealmsRealmIdentityProviderUploadCertificatePost(ctx context.Context, realm string) ApiAdminRealmsRealmIdentityProviderUploadCertificatePostRequest {
	return ApiAdminRealmsRealmIdentityProviderUploadCertificatePostRequest{
		ApiService: a,
		ctx:        ctx,
		realm:      realm,
...
//
//	@return CertificateRepresentation
func (a *ClientAttributeCertificateAPIService) AdminRealmsRealmIdentityProviderUploadCertificatePostExecute(r ApiAdminRealmsRealmIdentityProviderUploadCertificatePostRequest) (*CertificateRepresentation, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ClientAttributeCertificateAPIService.AdminRealmsRealmIdentityProviderUploadCertificatePost")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/admin/realms/{realm}/identity-provider/upload-certificate"
	localVarPath = strings.Replace(localVarPath, "{"+"realm"+"}", url.PathEscape(parameterValueToString(r.realm, "realm")), -1)
