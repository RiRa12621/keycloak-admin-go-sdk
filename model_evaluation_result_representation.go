...
// GetDeniedScopes returns the DeniedScopes field value if set, zero value otherwise.
func (o *EvaluationResultRepresentation) GetDeniedScopes() []ScopeRepresentation {
	if o == nil || IsNil(o.DeniedScopes) {
		var ret []ScopeRepresentation
		return ret
	}
	return o.DeniedScopes
}

// GetDeniedScopesOk returns a tuple with the DeniedScopes field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *EvaluationResultRepresentation) GetDeniedScopesOk() ([]ScopeRepresentation, bool) {
	if o == nil || IsNil(o.DeniedScopes) {
		return nil, false
	}
	return o.DeniedScopes, true
}

// HasDeniedScopes returns a boolean if a field has been set.
func (o *EvaluationResultRepresentation) HasDeniedScopes() bool {
	if o != nil && !IsNil(o.DeniedScopes) {
		return true
	}
...
// SetDeniedScopes gets a reference to the given []ScopeRepresentation and assigns it to the DeniedScopes field.
func (o *EvaluationResultRepresentation) SetDeniedScopes(v []ScopeRepresentation) {
	o.DeniedScopes = v
}
...
func (o EvaluationResultRepresentation) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.DeniedScopes) {
		toSerialize["deniedScopes"] = o.DeniedScopes
	}
