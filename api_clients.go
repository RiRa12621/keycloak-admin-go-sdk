...
func (r ApiAdminRealmsRealmClientsClientUuidEvaluateScopesGenerateExampleAccessTokenGetRequest) Audience(audience string) ApiAdminRealmsRealmClientsClientUuidEvaluateScopesGenerateExampleAccessTokenGetRequest {
	r.audience = &audience
	return r
}
...
func (r ApiAdminRealmsRealmClientsClientUuidEvaluateScopesGenerateExampleIdTokenGetRequest) Audience(audience string) ApiAdminRealmsRealmClientsClientUuidEvaluateScopesGenerateExampleIdTokenGetRequest {
	r.audience = &audience
	return r
}
...
func (a *ClientsAPIService) AdminRealmsRealmClientsGetExecute(r ApiAdminRealmsRealmClientsGetRequest) ([]ClientRepresentation, *http.Response, error) {
	...
	if r.viewableOnly != nil {
		...
		var defaultValue bool = false
		parameterAddToHeaderOrQuery(localVarQueryParams, "viewableOnly", defaultValue, "form", "")
