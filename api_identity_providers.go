...
func (r ApiAdminRealmsRealmIdentityProviderInstancesGetRequest) Capability(capability string) ApiAdminRealmsRealmIdentityProviderInstancesGetRequest {
...
func (r ApiAdminRealmsRealmIdentityProviderInstancesGetRequest) Type_(type_ string) ApiAdminRealmsRealmIdentityProviderInstancesGetRequest {
	r.type_ = &type_
	return r
}
