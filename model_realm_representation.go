...
// GetWebAuthnPolicyPasswordlessPasskeysEnabled returns the WebAuthnPolicyPasswordlessPasskeysEnabled field value if set, zero value otherwise.
func (o *RealmRepresentation) GetWebAuthnPolicyPasswordlessPasskeysEnabled() bool {
	if o == nil || IsNil(o.WebAuthnPolicyPasswordlessPasskeysEnabled) {
		var ret bool
		return ret
	}
	return *o.WebAuthnPolicyPasswordlessPasskeysEnabled
}

// GetWebAuthnPolicyPasswordlessPasskeysEnabledOk returns a tuple with the WebAuthnPolicyPasswordlessPasskeysEnabled field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RealmRepresentation) GetWebAuthnPolicyPasswordlessPasskeysEnabledOk() (*bool, bool) {
	if o == nil || IsNil(o.WebAuthnPolicyPasswordlessPasskeysEnabled) {
		return nil, false
	}
	return o.WebAuthnPolicyPasswordlessPasskeysEnabled, true
}

// HasWebAuthnPolicyPasswordlessPasskeysEnabled returns a boolean if a field has been set.
func (o *RealmRepresentation) HasWebAuthnPolicyPasswordlessPasskeysEnabled() bool {
	if o != nil && !IsNil(o.WebAuthnPolicyPasswordlessPasskeysEnabled) {
		return true
	}
...
// SetWebAuthnPolicyPasswordlessPasskeysEnabled gets a reference to the given bool and assigns it to the WebAuthnPolicyPasswordlessPasskeysEnabled field.
func (o *RealmRepresentation) SetWebAuthnPolicyPasswordlessPasskeysEnabled(v bool) {
	o.WebAuthnPolicyPasswordlessPasskeysEnabled = &v
}
...
func (o RealmRepresentation) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.WebAuthnPolicyPasswordlessPasskeysEnabled) {
		toSerialize["webAuthnPolicyPasswordlessPasskeysEnabled"] = o.WebAuthnPolicyPasswordlessPasskeysEnabled
	}
