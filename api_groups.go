...
func (a *GroupsAPIService) AdminRealmsRealmGroupsCountGetExecute(r ApiAdminRealmsRealmGroupsCountGetRequest) (map[string]int64, *http.Response, error) {
	...
	if r.top != nil {
		...
		parameterAddToHeaderOrQuery(localVarQueryParams, "top", defaultValue, "form", "")
		r.top = &defaultValue
	}
...
func (r ApiAdminRealmsRealmGroupsGetRequest) SubGroupsCount(subGroupsCount bool) ApiAdminRealmsRealmGroupsGetRequest {
	r.subGroupsCount = &subGroupsCount
	return r
}
...
func (a *GroupsAPIService) AdminRealmsRealmGroupsGetExecute(r ApiAdminRealmsRealmGroupsGetRequest) ([]GroupRepresentation, *http.Response, error) {
	...
	if r.populateHierarchy != nil {
		...
		var defaultValue bool = true
		parameterAddToHeaderOrQuery(localVarQueryParams, "populateHierarchy", defaultValue, "form", "")
	...
	if r.subGroupsCount != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "subGroupsCount", r.subGroupsCount, "form", "")
	} else {
		var defaultValue bool = true
		parameterAddToHeaderOrQuery(localVarQueryParams, "subGroupsCount", defaultValue, "form", "")
		r.subGroupsCount = &defaultValue
	}
	// to determine the Content-Type header
	localVarHTTPContentTypes := []string{}
...
func (r ApiAdminRealmsRealmGroupsGroupIdChildrenGetRequest) SubGroupsCount(subGroupsCount bool) ApiAdminRealmsRealmGroupsGroupIdChildrenGetRequest {
	r.subGroupsCount = &subGroupsCount
	return r
}
