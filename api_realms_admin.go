...
func (r ApiAdminRealmsRealmAdminEventsGetRequest) Direction(direction string) ApiAdminRealmsRealmAdminEventsGetRequest {
...
// The direction to sort events by (asc or desc)
func (r ApiAdminRealmsRealmEventsGetRequest) Direction(direction string) ApiAdminRealmsRealmEventsGetRequest {
	r.direction = &direction
	return r
}
...
func (r ApiAdminRealmsRealmPartialExportPostRequest) Execute() (*RealmRepresentation, *http.Response, error) {
...
//
//	@return RealmRepresentation
func (a *RealmsAdminAPIService) AdminRealmsRealmPartialExportPostExecute(r ApiAdminRealmsRealmPartialExportPostRequest) (*RealmRepresentation, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
...
func (r ApiAdminRealmsRealmPartialImportPostRequest) Execute() (map[string]interface{}, *http.Response, error) {
...
func (a *RealmsAdminAPIService) AdminRealmsRealmPartialImportPostExecute(r ApiAdminRealmsRealmPartialImportPostRequest) (map[string]interface{}, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
...
func (a *RealmsAdminAPIService) AdminRealmsRealmSessionsSessionDeleteExecute(r ApiAdminRealmsRealmSessionsSessionDeleteRequest) (*http.Response, error) {
	...
	if r.isOffline != nil {
		...
		var defaultValue bool = false
		parameterAddToHeaderOrQuery(localVarQueryParams, "isOffline", defaultValue, "form", "")
