...
func (o *CredentialRepresentation) GetFederationLink() string {
...
// and a boolean to check if the value has been set.
func (o *CredentialRepresentation) GetFederationLinkOk() (*string, bool) {
	if o == nil || IsNil(o.FederationLink) {
		return nil, false
	}
...
func (o *CredentialRepresentation) HasFederationLink() bool {
	if o != nil && !IsNil(o.FederationLink) {
		return true
	}
...
func (o *CredentialRepresentation) SetFederationLink(v string) {
	o.FederationLink = &v
}
