...
func Test_openapi_RealmsAdminAPIService(t *testing.T) {
	...
	t.Run("Test RealmsAdminAPIService AdminRealmsRealmPartialExportPost", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.RealmsAdminAPI.AdminRealmsRealmPartialExportPost(context.Background(), realm).Execute()
	...
	t.Run("Test RealmsAdminAPIService AdminRealmsRealmPartialImportPost", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.RealmsAdminAPI.AdminRealmsRealmPartialImportPost(context.Background(), realm).Execute()
