...
func (r ApiAdminRealmsRealmUsersCountGetRequest) Exact(exact bool) ApiAdminRealmsRealmUsersCountGetRequest {
	r.exact = &exact
	return r
}
...
func (r ApiAdminRealmsRealmUsersCountGetRequest) IdpAlias(idpAlias string) ApiAdminRealmsRealmUsersCountGetRequest {
	r.idpAlias = &idpAlias
	return r
}

// The userId at an Identity Provider linked to the user
func (r ApiAdminRealmsRealmUsersCountGetRequest) IdpUserId(idpUserId string) ApiAdminRealmsRealmUsersCountGetRequest {
...
func (r ApiAdminRealmsRealmUsersUserIdFederatedIdentityProviderPostRequest) FederatedIdentityRepresentation(federatedIdentityRepresentation FederatedIdentityRepresentation) ApiAdminRealmsRealmUsersUserIdFederatedIdentityProviderPostRequest {
	r.federatedIdentityRepresentation = &federatedIdentityRepresentation
	return r
}
...
func (a *UsersAPIService) AdminRealmsRealmUsersUserIdFederatedIdentityProviderPostExecute(r ApiAdminRealmsRealmUsersUserIdFederatedIdentityProviderPostRequest) (*http.Response, error) {
	...
	// body params
	localVarPostBody = r.federatedIdentityRepresentation
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return nil, err
	}
