...
## Overview
This API client was originally generated by the [OpenAPI Generator](https://openapi-generator.tech) project.
...
```go
import keycloak "github.com/rira12621/keycloak-admin-go-sdk"
```
...
*OrganizationsAPI* | [**AdminRealmsRealmOrganizationsCountGet**](docs/OrganizationsAPI.md#adminrealmsrealmorganizationscountget) | **Get** /admin/realms/{realm}/organizations/count | Returns the organizations counts.
...
*WorkflowsAPI* | [**AdminRealmsRealmWorkflowsGet**](docs/WorkflowsAPI.md#adminrealmsrealmworkflowsget) | **Get** /admin/realms/{realm}/workflows | List workflows
*WorkflowsAPI* | [**AdminRealmsRealmWorkflowsIdActivateTypeResourceIdPost**](docs/WorkflowsAPI.md#adminrealmsrealmworkflowsidactivatetyperesourceidpost) | **Post** /admin/realms/{realm}/workflows/{id}/activate/{type}/{resourceId} | Activate workflow for resource
*WorkflowsAPI* | [**AdminRealmsRealmWorkflowsIdDeactivateTypeResourceIdPost**](docs/WorkflowsAPI.md#adminrealmsrealmworkflowsiddeactivatetyperesourceidpost) | **Post** /admin/realms/{realm}/workflows/{id}/deactivate/{type}/{resourceId} | Deactivate workflow for resource
*WorkflowsAPI* | [**AdminRealmsRealmWorkflowsIdDelete**](docs/WorkflowsAPI.md#adminrealmsrealmworkflowsiddelete) | **Delete** /admin/realms/{realm}/workflows/{id} | Delete workflow
*WorkflowsAPI* | [**AdminRealmsRealmWorkflowsIdGet**](docs/WorkflowsAPI.md#adminrealmsrealmworkflowsidget) | **Get** /admin/realms/{realm}/workflows/{id} | Get workflow
*WorkflowsAPI* | [**AdminRealmsRealmWorkflowsIdPut**](docs/WorkflowsAPI.md#adminrealmsrealmworkflowsidput) | **Put** /admin/realms/{realm}/workflows/{id} | Update workflow
*WorkflowsAPI* | [**AdminRealmsRealmWorkflowsPost**](docs/WorkflowsAPI.md#adminrealmsrealmworkflowspost) | **Post** /admin/realms/{realm}/workflows | Create workflow
*WorkflowsAPI* | [**AdminRealmsRealmWorkflowsScheduledResourceIdGet**](docs/WorkflowsAPI.md#adminrealmsrealmworkflowsscheduledresourceidget) | **Get** /admin/realms/{realm}/workflows/scheduled/{resource-id} | List scheduled workflows for resource
...
## Documentation For Models
 ...
 - [OrganizationInvitationRepresentation](docs/OrganizationInvitationRepresentation.md)
 ...
 - [WorkflowConcurrencyRepresentation](docs/WorkflowConcurrencyRepresentation.md)
 - [WorkflowRepresentation](docs/WorkflowRepresentation.md)
 - [WorkflowScheduleRepresentation](docs/WorkflowScheduleRepresentation.md)
 - [WorkflowStateRepresentation](docs/WorkflowStateRepresentation.md)
 - [WorkflowStepRepresentation](docs/WorkflowStepRepresentation.md)
